...
People do, and it can be made to work. There is no official rule set, but the rules used by
[Kotlin Explorer](https://github.com/romainguy/kotlin-explorer/blob/main/compose-desktop.pro)
...
rather than a settled answer — an upgrade can break it, and the symptom is usually a
missing resource or a crash a long way from the cause.
